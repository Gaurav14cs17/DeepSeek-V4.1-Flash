...
Usage:
  ...
  python -m toy_dsv41.utils.plot_history --history path/to/history.json
"""
...
from toy_dsv41.utils.plotting import plot_from_file
...
def main() -> None:
    ...
    if not history.exists():
        raise SystemExit(
            f"missing {history}\n"
            "Train first: python -m toy_dsv41.train --preset better"
        )
